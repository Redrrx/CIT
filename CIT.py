...
route_master = 'cmdp.exe route -p add' + vivox_ms + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_r6s = 'cmdp.exe route -p add' + r6s_vcs + 'mask' + '255.255.255.255 ' + IP  + '>nul 2>&1'
route_r6s1 = 'cmdp.exe route -p add' + r6s_vcs1 + 'mask' + '255.255.255.255 ' + IP  + '>nul 2>&1'
route_r6s2 = 'cmdp.exe route -p add' + r6s_vcs2 + 'mask' + '255.255.255.255 ' + IP  + '>nul 2>&1'
route_r6s3 = 'cmdp.exe route -p add' + r6s_vcs3 + 'mask' + '255.255.255.255 ' + IP  + '>nul 2>&1'
route_r6s4 = 'cmdp.exe route -p add' + r6s_vcs4 + 'mask' + '255.255.255.255 ' + IP  + '>nul 2>&1'
route_r6s5 = 'cmdp.exe route -p add' + r6s_vcs5 + 'mask' + '255.255.255.255 ' + IP  + '>nul 2>&1'
route_pubg ='cmdp.exe route -p add' + pubg_vcs +'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_vxx1 = 'cmdp.exe route -p add' + vxx1 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_vxx2 = 'cmdp.exe route -p add' + vxx2 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_vxx3 = 'cmdp.exe route -p add' + vxx3 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_vxx4 = 'cmdp.exe route -p add' + vxx4 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_vxx5 = 'cmdp.exe route -p add' + vxx5 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_vxx6 = 'cmdp.exe route -p add' + vxx6 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_vxx7 = 'cmdp.exe route -p add' + vxx7 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_vxx8 = 'cmdp.exe route -p add' + vxx8 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_pubgx = 'cmdp.exe route -p add 18.0.0.0/8 '+ IP  + '>nul 2>&1'

#routing R6S PS4 voice chat
route_r6s_vcsp = 'cmdp.exe route -p add' + r6s_vcsp + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_r6s_vcsp1 = 'cmdp.exe route -p add' + r6s_vcsp1 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_r6s_vcsp2 = 'cmdp.exe route -p add' + r6s_vcsp2 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_r6s_vcsp3 = 'cmdp.exe route -p add' + r6s_vcsp3 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_r6s_vcsp4 = 'cmdp.exe route -p add' + r6s_vcsp4 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_r6s_vcsp5 = 'cmdp.exe route -p add' + r6s_vcsp5 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_r6s_vcsp6 = 'cmdp.exe route -p add' + r6s_vcsp6 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_r6s_vcsp7 = 'cmdp.exe route -p add' + r6s_vcsp7 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_r6s_vcsp8 = 'cmdp.exe route -p add' + r6s_vcsp8 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_r6s_vcsp9 = 'cmdp.exe route -p add' + r6s_vcsp9 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_r6s_vcsp10 = 'cmdp.exe route -p add' + r6s_vcsp10 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_r6s_vcsp11 = 'cmdp.exe route -p add' + r6s_vcsp11 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_r6s_vcsp12 = 'cmdp.exe route -p add' + r6s_vcsp12 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_r6s_vcsp13 = 'cmdp.exe route -p add' + r6s_vcsp13 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_r6s_vcsp14 = 'cmdp.exe route -p add' + r6s_vcsp14 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_r6s_vcsp15 = 'cmdp.exe route -p add' + r6s_vcsp15 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_r6s_vcsp16 = 'cmdp.exe route -p add' + r6s_vcsp16 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'

# the xbox part, why im i even doing this ffs..


route_r6s_vcxb = 'cmdp.exe route -p add' + r6s_vcsxb + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_r6s_vcxb1 = 'cmdp.exe route -p add' + r6s_vcsxb1 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_r6s_vcxb2 = 'cmdp.exe route -p add' + r6s_vcsxb2 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_r6s_vcxb3 = 'cmdp.exe route -p add' + r6s_vcsxb3 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_r6s_vcxb4 = 'cmdp.exe route -p add' + r6s_vcsxb4 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_r6s_vcxb5 = 'cmdp.exe route -p add' + r6s_vcsxb5 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_r6s_vcxb6 = 'cmdp.exe route -p add' + r6s_vcsxb6 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_r6s_vcxb7 = 'cmdp.exe route -p add' + r6s_vcsxb7 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'

# The boring network stuff part 3
route_fn = 'cmdp.exe route -p add' + vxx_fn + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_fn2 = 'cmdp.exe route -p add' + vxx_fn2 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_fn3 = 'cmdp.exe route -p add' + vxx_fn3 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_fn4 = 'cmdp.exe route -p add' + vxx_fn4 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_fn5 = 'cmdp.exe route -p add' + vxx_fn5 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_fn6 = 'cmdp.exe route -p add' + vxx_fn6 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_fn7 = 'cmdp.exe route -p add' + vxx_fn7 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_fn8 = 'cmdp.exe route -p add' + vxx_fn8 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_fn9 = 'cmdp.exe route -p add' + vxx_fn9 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_fn10 = 'cmdp.exe route -p add' + vxx_fn10 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_fn11 = 'cmdp.exe route -p add' + vxx_fn11 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_fn12 = 'cmdp.exe route -p add' + vxx_fn12 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_fn13 = 'cmdp.exe route -p add' + vxx_fn13 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_fn14 = 'cmdp.exe route -p add' + vxx_fn14 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'

route_h1z1 = 'cmdp.exe route -p add' + vxx_h1Z1 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_h1z12 = 'cmdp.exe route -p add' + vxx_h1Z12 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_h1z13 = 'cmdp.exe route -p add' + vxx_h1Z13 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_h1z14 = 'cmdp.exe route -p add' + vxx_h1Z14 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_h1z15 = 'cmdp.exe route -p add' + vxx_h1Z15 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'
route_h1z16 = 'cmdp.exe route -p add' + vxx_h1Z16 + 'mask' + '255.255.255.255' + IP  + '>nul 2>&1'

# The boring network stuff part 4
# will add new unroute for other servers soon
unroute_master = 'cmdp.exe route delete ' + vivox_ms + '>nul 2>&1'
unroute_r6s = 'cmdp.exe route delete ' + r6s_vcs + '>nul 2>&1'
unroute_r6s1= 'cmdp.exe route delete ' + r6s_vcs1 + '>nul 2>&1'
unroute_r6s2= 'cmdp.exe route delete ' + r6s_vcs2 + '>nul 2>&1'
unroute_r6s3= 'cmdp.exe route delete ' + r6s_vcs3 + '>nul 2>&1'
unroute_r6s4= 'cmdp.exe route delete ' + r6s_vcs4 + '>nul 2>&1'
unroute_r6s5= 'cmdp.exe route delete ' + r6s_vcs5 + '>nul 2>&1'
unroute_pubg = 'cmdp.exe route delete ' + pubg_vcs + '>nul 2>&1'
unroute_vxx1 = 'cmdp.exe route delete ' + vxx1 + '>nul 2>&1'
unroute_vxx2 = 'cmdp.exe route delete ' + vxx2 + '>nul 2>&1'
unroute_vxx3 = 'cmdp.exe route delete ' + vxx3 + '>nul 2>&1'
unroute_vxx4 = 'cmdp.exe route delete ' + vxx4 + '>nul 2>&1'
unroute_vxx5 = 'cmdp.exe route delete ' + vxx5 + '>nul 2>&1'
unroute_vxx6 = 'cmdp.exe route delete ' + vxx6 + '>nul 2>&1'
unroute_vxx7 = 'cmdp.exe route delete ' + vxx7 + '>nul 2>&1'
unroute_vxx8 = 'cmdp.exe route delete ' + vxx8 + '>nul 2>&1'
unroute_pubgx = 'cmdp.exe route delete  18.0.0.0/8' + '>nul 2>&1'
unroute_fn = 'cmdp.exe route delete ' + vxx_fn + '>nul 2>&1'
unroute_fn2= 'cmdp.exe route delete ' + vxx_fn2 + '>nul 2>&1'
unroute_fn3= 'cmdp.exe route delete ' + vxx_fn3 + '>nul 2>&1'
unroute_fn4= 'cmdp.exe route delete ' + vxx_fn4 + '>nul 2>&1'
unroute_fn5= 'cmdp.exe route delete ' + vxx_fn5 + '>nul 2>&1'
unroute_fn6= 'cmdp.exe route delete ' + vxx_fn6 + '>nul 2>&1'
unroute_fn7= 'cmdp.exe route delete ' + vxx_fn7 + '>nul 2>&1'
unroute_fn8= 'cmdp.exe route delete ' + vxx_fn8 + '>nul 2>&1'
unroute_fn9= 'cmdp.exe route delete ' + vxx_fn9 + '>nul 2>&1'
unroute_fn10= 'cmdp.exe route delete ' + vxx_fn10 + '>nul 2>&1'
unroute_fn11= 'cmdp.exe route delete ' + vxx_fn11 + '>nul 2>&1'
unroute_fn12= 'cmdp.exe route delete ' + vxx_fn12 + '>nul 2>&1'
unroute_fn13= 'cmdp.exe route delete ' + vxx_fn13 + '>nul 2>&1'
unroute_H1Z1 =  'cmdp.exe route delete ' + vxx_h1Z1 + '>nul 2>&1'
unroute_H1Z12 =  'cmdp.exe route delete ' + vxx_h1Z12 + '>nul 2>&1'
unroute_H1Z13 =  'cmdp.exe route delete ' + vxx_h1Z13 + '>nul 2>&1'
unroute_H1Z14 =  'cmdp.exe route delete ' + vxx_h1Z14 + '>nul 2>&1'
unroute_H1Z15 =  'cmdp.exe route delete ' + vxx_h1Z15 + '>nul 2>&1'
unroute_H1Z16 =  'cmdp.exe route delete ' + vxx_h1Z16 + '>nul 2>&1'
